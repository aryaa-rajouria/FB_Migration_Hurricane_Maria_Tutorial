...
1. Create a developer account and obtain an [access token](https://developers.facebook.com/tools/accesstoken) as a Facebook developer.
1. Access Facebook data that is publicly [available](https://developers.facebook.com/docs/graph-api) if want to collect data on anything that is available publicly
1. Requires Python: install the pySocialWatcher which can be found [here](https://github.com/maraujo/pySocialWatcher).
...
Here are some descriptives and visualizations to better understand the clean data. Each new 'wave' of data is collected on the first of the month, every couple of months.
...
## Total expats
Similarly, the FB data can be used to estimate the size of the immigrant population in the US (FB calls this the expat population).  As is evident from the table below, the number of migrants in the US is steady from Wave 1 to Wave 5. There is a decrease from Wave 4 to Wave 5. Wave 6 and Wave 7 are more similar to each other. 
...
Now, we will examine the age patterns of migrants within the different waves. The FB data only contains information on individuals between the ages of 15 to 59. As per the table and graph below, of all the migrants in the Facebook data, there were more migrants in their mid-20s and mid-30s compared to younger (teenagers) or older (past 50) populations. All of the waves had similar age patterns. 
...
We see similar patterns in wave 5 (Jan 2018).
